/* URI - 2991: https://www.urionlinejudge.com.br/judge/pt/problems/view/2991 */
...
SELECT 
	...
	COUNT(employee_salary.matr) AS "Numero de Empregados",
	ROUND(AVG(employee_salary.salary - employee_discount.discount), 2) AS "Media Salarial",
	ROUND(MAX(employee_salary.salary - employee_discount.discount), 2) AS "Maior Salario",
	
	CASE MIN(employee_salary.salary - employee_discount.discount) 
		WHEN 0 THEN ROUND(MIN(employee_salary.salary - employee_discount.discount), 0)
		ELSE ROUND(MIN(employee_salary.salary - employee_discount.discount), 2)
...
(
	...
	GROUP BY empregado.matr, lotacao
...
JOIN departamento ON departamento.cod_dep = employee_salary.lotacao
GROUP BY departamento.cod_dep, "Nome Departamento"
