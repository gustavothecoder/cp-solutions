/* URI - 2989: https://www.urionlinejudge.com.br/judge/pt/problems/view/2989 */
...
SELECT 
  ...
  divisao.nome as divisao,
	...
	ROUND(MAX(employee_salary.salary - employee_discount.discount), 2) as maior
FROM  

(
	SELECT 
		empregado.matr as matr, 
		empregado.lotacao_div as division, 
	...
	GROUP BY empregado.matr, division
...
JOIN divisao ON divisao.cod_divisao = employee_salary.division
